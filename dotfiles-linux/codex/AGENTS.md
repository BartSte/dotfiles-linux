...
- You may develop Windows-only projects from WSL. When you execute code from a Windows-only project, call a Windows executable. For Python projects, use `wuv`, `wpy`, and `try-uv-install` to call Windows Python interpreters and install dependencies.
