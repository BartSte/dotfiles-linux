...
export FZF_DEFAULT_COMMAND="fd --hidden --no-ignore-vcs --max-depth 3 --ignore-file $HOME/.ignore --type f"
export FZF_DEFAULT_OPTS="--height 100% --layout=reverse --preview-window=right,65%"

_FZF_CTRL_T_OPTS_FILES='bat --theme=gruvbox-dark --style=numbers --color=always --line-range :500 {}'
_FZF_CTRL_T_OPTS_DIR='exa --icons -T -a {} | head -200'
...
_FZF_CTRL_T_OPTS_BIND+="ctrl-a:toggle-preview"
...
export FZF_ALT_C_OPTS+="--bind 'ctrl-a:toggle-preview' "
...
_fzf_compgen_path() {
  fd --hidden --follow --max-depth 3 --ignore-file $HOME/.ignore . "$1"
}

_fzf_compgen_dir() {
  fd --type d --hidden --follow --max-depth 3 --ignore-file $HOME/.ignore . "$1"
}
