...
alias bases='/usr/bin/git --git-dir=$HOME/dotfiles.git/ --work-tree=$HOME status --untracked-files=no --short'
...
alias tn='tmux new'
alias tm='tmux neww ~/dotfiles-linux/scripts/tmux-sessionizer.bash'
alias rm='trash-put'
