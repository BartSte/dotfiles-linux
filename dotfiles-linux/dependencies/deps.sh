dependencies=("java-openjfx" "python-gpgme" "aspell" "aspell-nl" "aspell-en" "texlive-bin" "pandoc" "fzf" "python" "python-markdown" "powerline-fonts" "exa" "trash-cli" "unzip" "python-pip" "the_silver_searcher" "mutt" "tmux" "bat" "lynx" "make" "alacritty" "tree" "fd" "poppler" "antiword" "odt2txt" "tar" "p7zip" "fuse2" "fuse3" "fuse-common" "inetutils" "redshift" "base-devel" "neofetch" "ccls" "gdb" "make" "cmake" "wget" "htop" "man-db" "ripgrep" "xclip" "wl-clipboard")
